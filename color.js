// Modified bundle of github.com/Qix-/color v3.1.2
var Color = (function () {
	'use strict';
	...
	var swizzle = function swizzle(args) {
		var results = [];
	...
	for (var name in cssKeywords) {
		if (cssKeywords.hasOwnProperty(name)) {
	...
	*/
	...
	function deriveBFS(fromModel) {
		...
		while (queue.length) {
			...
			var adjacents = Object.keys(convert[current]);
	...
	function wrapConversion(toModel, graph) {
		...
		var fn = convert[graph[toModel].parent][toModel];
	...
	var hashedModelKeys = {};
	Object.keys(convert$1).forEach(function (model) {
		hashedModelKeys[_slice.call(convert$1[model].labels).sort().join('')] = model;
	});
	...
	function Color(obj, model) {
		...
		if (obj == null) { // eslint-disable-line no-eq-null,eqeqeq
			...
			var labels = convert$1[this.model].labels;
			var color = [];
	...
	Color.prototype = {
		...
		string: function (places) {
			var self = this.model in cs.to ? this : this.rgb();
		...
		object: function () {
			var result = {};
			var channels = convert$1[this.model].channels;
			var labels = convert$1[this.model].labels;
	...
	Object.keys(convert$1).forEach(function (model) {
		...
		Color.prototype[model] = function () {
			...
			return new Color(assertArray(convert$1[this.model][model].raw(this.color)).concat(newAlpha), model);
		};
